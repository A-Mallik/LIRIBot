...
function spotifyThis(){
            var input2 = process.argv.slice(3).join(" "); // join any input after process.argv[2] by " " to get a proper input if it includes space
            if (input2 === "") {
              input2 = "The Sign";         //default to 'The Sign' as per instructions
...
function concertThis(){
    ...
    // console.log("Input 2: " + process.argv.slice(3).join(" "));  make sure input is considering spaces
...
function doSays(){
  ...
  fs.readFile('./random.txt', 'utf8', function(err, contents) {
            ...
            if(process.argv[2] === "spotify-this-song"){   // check for different commands in the text file
                process.argv[3] = encodeURIComponent(arrayThis[1]);
                  spotifyThis();
            }
